...
class AscendModelCollector:
    def __init__(self, config_file="config.yaml"):
        self.data_dir = "data"
        self.output_file = os.path.join(self.data_dir, "ascend_models.json")
    ...
    def load_config(self, config_file):
        ...
        default_config = {
            ...
            "collection": {
                "output_dir": "data",
                "output_file": "ascend_models.json",
                "deduplicate": False,
                "sort_by_stars": True,
                "log_level": "INFO",
            },
    ...
    def run(self):
        ...
        output_file = collection_config.get("output_file", "ascend_models.json")
